...
class FrontendController extends Controller
{
    ...
    public function posts($postCategorySlug = null)
    {
        ...
        if ($postCategorySlug) {
            ...
            if (!$post_category) return response()->json([
                'message' => UtilController::message($cms['pages'][env('VITE_DEFAULT_LANG', 'fr')]['messages']['post_categories']['not_found'], 'danger'),
            ]);
    ...
    public function post($postCategorySlug, $slug)
    {
        ...
        if (!$post) return response()->json([
            'message' => UtilController::message($cms['pages'][env('VITE_DEFAULT_LANG', 'fr')]['messages']['posts']['not_found'], 'danger'),
        ]);
    ...
    public function product($slug)
    {
        ...
        if (!$product) return response()->json([
            'message' => UtilController::message($cms['pages'][env('VITE_DEFAULT_LANG', 'fr')]['messages']['products']['not_found'], 'danger'),
        ]);
