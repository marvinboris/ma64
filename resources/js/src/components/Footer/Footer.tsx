    ...
    render() {
        ...
        return (
            <div
                ...
                style={{
                    background:
                        'linear-gradient(rgba(0, 0, 0, .45), rgba(0, 0, 0, .45)), url("' +
                        Background +
                        '") no-repeat center',
            ...
            >
                <div
                    ...
                    style={{ opacity: 0.7, top: 0, zIndex: 1 }}
                />
                    ...
                    <Container>
                        <footer className="text-light py-5">
                            <Row>
                                        ...
                                        <dl className="d-flex flex-wrap">
                                            <div className="flex-fill w-100 d-flex">
                                                ...
                                                <dl className="flex-grow-1 pl-sm-4 text-300">
                                                    {top.phone_email.phone.value.map(
                                                        (val) => (
                                                            <div
                                                                key={
                                                                    val +
                                            ...
                                            <div className="flex-fill w-100 d-flex">
                                                ...
                                                <div />
                                                <dl className="flex-grow-1 pl-sm-4 text-300">
                                                    {top.phone_email.email.value.map(
                                                        (val) => (
                                                            <div
                                                                key={
                                                                    val +
                                            ...
                                            <div className="form-group">
                                                <div className="input-group">
                                                    <input
                                                        ...
                                                        className="form-control rounded-pill bg-white-10 rounded-right-0 border-white-50"
                                                    />
                                ...
                                <Col>
                                    ...
                                    <FooterBlock
                                        title={top.facebook_likes.title}
                                        className="mt-4"
                                    >
                                        <a
                                            className="w-100 text-decoration-none text-reset d-block"
                                            href={
                                                bottom.social_networks.facebook
                                            }
                                        >
                                            <img
                                                src={Facebook}
                        ...
                        <footer className="text-light pb-4">
                            <div className="border-top border-white-20 d-flex justify-content-between align-items-center pt-4">
                                <div>
                                    © Copyrights 2020{" "}
                                    <span className="text-white text-700">
                                        {app_name}
                                    </span>
                                    . {bottom.all_rights_reserved}.
                                </div>

                                <div className="d-flex">
                                    <a
                                        href={bottom.social_networks.facebook}
                                        className="mr-3"
                                    >
                                        <i className="fab fa-2x fa-facebook-square text-facebook" />
                                    </a>
                                    <a
                                        href={bottom.social_networks.linkedin}
                                        className="mr-3"
                                    >
                                        <i className="fab fa-2x fa-linkedin text-linkedin" />
                                    </a>
                                    <a
                                        href={bottom.social_networks.youtube}
                                        className="mr-3"
                                    >
                                        <i className="fab fa-2x fa-youtube-square text-youtube" />
                                    </a>
                                    <a
                                        href={bottom.social_networks.instagram}
                                        className="mr-3"
                                    >
                                        <i className="fab fa-2x fa-instagram-square text-black" />
                                    </a>
                                    <a href={bottom.social_networks.whatsapp}>
                                        <i className="fab fa-2x fa-whatsapp-square text-whatsapp" />
                                    </a>
                                </div>
                            </div>
                        </footer>
