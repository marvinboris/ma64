            ...
            <ModalBody className="text-center">
                ...
                <div>
                    <Button color="green" onClick={logoutHandler}>
                        {cms.header.logout}{" "}
                        <i className="fas fa-power-off fa-fw" />
                    </Button>{" "}
                    <Button color="red" onClick={modalToggle}>
                        {cms.header.close} <i className="fas fa-times fa-fw" />
                    </Button>
                </div>
            </ModalBody>
        </>
    ...
    return (
        <>
            <UncontrolledDropdown inNavbar>
                <DropdownToggle
                    nav
                    className="text-16 text-md-20 text-xxl-24 rounded-4 p-1 p-md-2 p-xxl-3 bg-greenblue-10 m-0"
                >
                ...
                <DropdownMenu right>
                    ...
                    >
                        <i className="fas fa-power-off fa-fw mr-2 text-blue" />
                        {cms.header.logout}
                    </div>
                </DropdownMenu>
            </UncontrolledDropdown>
